...
Statistic_table<- read.csv("../EXPERIMENT2/Results/Statistics_table.txt",sep="\t",header=T,row.names=1)

percentages<-Statistic_table[c(12,22,21,13,14,17),  ] 

 
otus<-read.csv("../EXPERIMENT2/Results/Decontaminated_OTU_Table.txt",sep="\t", header=T,row.names=1)
...
dev.new()
svg("EXPERIMENT_2_decontaminated_otus.svg",width=20,height=9)
