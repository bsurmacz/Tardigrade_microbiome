...
Statistic_table<- read.csv("../EXPERIMENT2/RENAMED/Results/Statistics_table.txt",sep="\t",header=T,row.names=1)
...
dev.new()
svg("EXPERIMENT_2_contamination_plot.svg",width=20,height=9)
